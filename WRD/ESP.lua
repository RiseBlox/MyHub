...
_G.WRDESPTeamColors = true --Distinguish different teams by their team color. If the game sets one.
_G.WRDESPTracers = false --Displays lines leading to other players.
_G.WRDESPNames = false --Displays the names of the players within the ESP box.
